...
function notify(type, title, message){
    this.notify(type, title, message, '5000');
}
...
function notify(type, title, message, duration){
    ...
    switch(toast_type){
        ...
        //DEFAULT
        default:           toast_icon = '<i style="font-size: 20px;" class="bi bi-'+ toast_type +'"></i>';
    }
    ...
    $('<div>',{
        ...
        .html(`<div class="toast-content">
                    <div class="toast-icon">${toast_icon}</div>
                    <div class="toast-body">
                        <strong>${toast_title}</strong>
                        <div>${toast_message}</div>
                    </div></div>
                <!--button class="btn-close close" type="button" data-dismiss="toast" aria-label="Close">
                    <span aria-hidden="true">${toast_btn_close_svg}</span>
                </button-->
                <button type="button" class="toast-close-button" data-dismiss="toast">&times;</button>
                `)
